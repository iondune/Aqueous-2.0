...
void main()
{
	...
	float CurrentDepth = texture(uDepthTexture, ((fPosition.xy / fPosition.w) + 1.0) / 2.0).r;
	...
	for(i = 0; i < IterationMax; i ++)
	{
		...
		vec4 ScreenCoords = uProjectionMatrix * uViewMatrix * WorldCoords;
